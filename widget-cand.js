(function () {
    // ─── KILL SWITCH ─────────────────────────────────────────────────────────────
    // Provador desligado no front (pedido do lojista, 09/07/2026). Backend segue ativo.
    // Para religar: mudar para false (e dar deploy no github.io/shopifycand).
    var PROVADOR_OFF = true;
    ...
    // ===============================================
    const apiKey = "7ceb7fc8a89baf4f8de3a6965a8f79ef9c9df0b518dcd515a5516f7897f4b8fc";
    ...
    const WEBHOOK_CHECK_LIMIT = 'https://n8n.segredosdodrop.com/webhook/cand-check-limit';
